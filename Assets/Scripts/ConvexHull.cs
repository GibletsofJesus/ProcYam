...
//Source:
//http://www.habrador.com/tutorials/linear-algebra/8-convex-hull/
public static class ConvexHull
{
    //Generate a convex hull with Graham's Scan algorithm
    public static List<Vector3> GenerateConvexHull(List<Vector3> unSortedList)
    {
        ...
        //DisplayConvexHull(convexHullList);
    ...
    public static void DisplayConvexHull(List<Vector3> verticesList)
    {
        float height = 0.1f;
